...
class UserRegisterPage extends GetWidget<UseRegisterController> {
  @override
...
class RegisterScreenUI extends StatelessWidget {
  final UseRegisterController loginController;
  ...
  Widget build(BuildContext context) {
    return Center(
      child: SingleChildScrollView(
        ...
        child: Obx(() => loginController.getState.getScreenWidget(_body(), (){})),
      ),
    );
  }
